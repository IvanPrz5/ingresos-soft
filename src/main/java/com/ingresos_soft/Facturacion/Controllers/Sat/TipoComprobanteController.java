...
import com.ingresos_soft.Facturacion.Services.Sat.TipoComprobanteService;
...
public class TipoComprobanteController {
    ...
    public ResponseEntity<ResultObjectResponse> findById(@PathVariable("id") Long id) {
        try {
            return ResponseEntity.status(HttpStatus.ACCEPTED)
                                 .body(MessageResponse.success(tipoComprobanteService.findById(id)));
        } catch (Exception e) {
    ...
    public ResponseEntity<ResultObjectResponse> findAll() {
        try {
            return ResponseEntity.status(HttpStatus.ACCEPTED)
                                 .body(MessageResponse.success(tipoComprobanteService.findAll()));
        } catch (Exception e) {
